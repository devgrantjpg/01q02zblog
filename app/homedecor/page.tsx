    ...
    <>
      ...
      <div style={styles.page}>
        ...
        {[
          ...
          [
            { title: "Classic Radio", href: "", src: "/img/smlgVasesColors (6).jpeg" },
            { title: "Classic Radio", href: "", src: "/img/igCeramicHandmade (1).jpeg" },
            { title: "Classic Radio", href: "", src: "/img/igCeramicHandmade (2).jpeg" },
          ],
          [
            { title: "Classic Radio", href: "", src: "/img/img/igCeramicHandmade (3).jpeg" },
            { title: "Classic Radio", href: "", src: "/img/img/igCeramicHandmade (4).jpeg" },
            { title: "Curved Computer Monitor", href: "", src: "/img/igCeramicHandmade (1).jpeg" },
          ],
          [
            { title: "Computer Monitor", href: "", src: "/img/igCeramicHandmade (5).jpeg" },
            { title: "Computer Monitor", href: "", src: "/img/igCeramicHandmade (6).jpeg" },
            { title: "Computer Monitor", href: "", src: "/img/igCeramicHandmade (7).jpeg" },
          ],
        //   [
